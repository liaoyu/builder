...
Module Federation 相关的配置，除了自定义的参数 `disableTypesPlugin` 用于控制是否开启 `@module-federation/typescript` 插件，其余参数均会透传给 [ModuleFederationPlugin](https://webpack.js.org/plugins/module-federation-plugin)